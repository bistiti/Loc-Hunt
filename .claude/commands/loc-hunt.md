...
argument-hint: "[matin|midi|soir] (optionnel — sinon déduit de l'heure)"
---
...
## 2. Créneau & mode
- Créneau de ce run : `$ARGUMENTS` (matin, midi ou soir). Si vide, déduis-le de l'heure locale (avant 11 h = matin, 11–16 h = midi, sinon soir).
